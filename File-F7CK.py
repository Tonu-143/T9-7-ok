...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m     TONU : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m TONU PUBLIC ID COINING ")
		print("")
		try:
	...
	linex()
	print("")
	print("\033[92;1m TONU HACKING HAS BEEN COMPLETED")
